...
//     CU_ASSERT_STRING_EQUAL(db_get_name(adidas), ioopm_strdup("adidas"));
//     CU_ASSERT_STRING_EQUAL(db_get_desc(adidas), ioopm_strdup("bra skor"));
...
//     merch_t *nixe = db_create_merch(nameB, descB, 50, nameB, nameB, nameB);
