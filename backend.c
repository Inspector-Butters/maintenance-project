...
int db_merch_count(webstore_t *db) { return ioopm_hash_table_size(db->merchs); }
...
char *db_get_name(merch_t *merch) { return merch->name; }

char *db_get_desc(merch_t *merch) { return merch->desc; }

int db_get_price(merch_t *merch) { return merch->price; }
